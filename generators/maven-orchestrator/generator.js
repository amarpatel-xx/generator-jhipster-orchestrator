...
// real generation — generated services contain no `template-file-maven-orchestrator` stub. The
// SQL Maven-heap customization that used to (try to) live here was moved to
// `spring-boot-orchestrator` POST_WRITING (`.mvn/jvm.config`), which provably runs for SQL services.
    ...
    return this.asWritingTaskGroup({
      async writingTemplateTask({ application }) {
        await this.writeFiles({
          sections: { files: [{ templates: ['template-file-maven-orchestrator'] }] },
          context: application,
        });
      },
    });
